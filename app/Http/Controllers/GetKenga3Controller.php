...
class GetKenga3Controller extends Controller
{
    protected $base_url = '';
    ...
    protected function parseProducts()
    {
        // pre('test3221',1);
        $products = [];
        $categoryUrl = 'http://kinga.com.ua/index.php?categoryID=300000&offset=';
        $categoryName = 'Женские трусики';
        // pre($categoryName,1);
        for ($offset = 0; $offset<=496; $offset+=16){
...
// pre($imageLink,1);                    
            ...
            $product['keyWords']                = 'нижнее белье, белье нижнее, трусы, трусики, трусы женские, трусики женские, стринги';
