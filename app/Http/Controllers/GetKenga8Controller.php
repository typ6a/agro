...
class GetKenga8Controller extends Controller
{
    protected $base_url = '';
    ...
    protected function parseProducts()
    {
        // pre('test3221',1);
        $products = [];
        $categoryUrl = 'http://kinga.com.ua/index.php?categoryID=800000&offset=';
        $categoryName = 'Колготки, чулки';
        // pre($categoryName,1);
        for ($offset = 0; $offset<=383; $offset+=16){
...
// pre($imageLink,1);                    
            ...
            $product['keyWords']                = 'колготки, чулки, колготы';
