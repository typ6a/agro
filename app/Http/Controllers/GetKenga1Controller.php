...
class GetKenga1Controller extends Controller
{
    protected $base_url = '';
    ...
    protected function parseProducts()
    {
        // pre('test3221',1);
        $products = [];
        $categoryUrl = 'http://kinga.com.ua/index.php?categoryID=100000&offset=';
        $categoryName = 'Комплекты нижнего белья';
        // pre($categoryName,1);
...
// pre($imageLink,1);                    
			...
			$product['keyWords']                = 'комплекты нижнего белья, комплекты нижнего белья, белье, нижнее белье, белье нижнее, трусы, трусики, лифчик, лифчики, бюстгалтер, бюстгалтеры, трусы женские, трусики женские, стринги';
