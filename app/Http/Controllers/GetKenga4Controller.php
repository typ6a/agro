...
class GetKenga4Controller extends Controller
{
    protected $base_url = '';
    ...
    protected function parseProducts()
    {
        // pre('test3221',1);
        $products = [];
        $categoryUrl = 'http://kinga.com.ua/index.php?categoryID=400000&offset=';
        $categoryName = 'Эротическое и сексуальное белье';
        // pre($categoryName,1);
        for ($offset = 0; $offset<=848; $offset+=16){
...
// pre($imageLink,1);                    
            ...
            $product['keyWords']                = 'эротическое, эротичное, эротическое белье, эротичное белье, пеньюар, сексуальное, сексуальное белье, секси';
