...
class GetKenga7Controller extends Controller
{
    protected $base_url = '';
    ...
    protected function parseProducts()
    {
        // pre('test3221',1);
        $products = [];
        $categoryUrl = 'http://kinga.com.ua/index.php?categoryID=700000&offset=';
        $categoryName = 'Корректирующее белье';
        // pre($categoryName,1);
        for ($offset = 0; $offset<=176; $offset+=16){
...
// pre($imageLink,1);                    
            ...
            $product['keyWords']                = 'корректирующее белье, утягивающее белье, утягивающий, утягивающие, утягивающее, бретельки, шортики, подвязки';
