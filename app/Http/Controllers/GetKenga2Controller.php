...
class GetKenga2Controller extends Controller
{
    protected $base_url = '';
    ...
    protected function parseProducts()
    {
        // pre('test3221',1);
        $products = [];
        $categoryUrl = 'http://kinga.com.ua/index.php?categoryID=200000&offset=';
        $categoryName = 'Бюстгальтеры (Лифчики)';
        // pre($categoryName,1);
...
// pre($imageLink,1);                    
            ...
            $product['keyWords']                = 'лифчик, лифчики, бюстгалтер, бюстгалтеры';
